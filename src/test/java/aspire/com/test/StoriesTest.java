...
/*import aspire.com.util.JSONUtil;
...
public class StoriesTest extends JUnitStories {
	...
	static String storiesPathToRun = "TC04_Verify_the_functionality_of_‘Follow’_button_for_a_non-followed_brand";
...
//		 new
//		 	().readJsonFile(this.getClass().getResourceAsStream("/configs/drivers.json"),
